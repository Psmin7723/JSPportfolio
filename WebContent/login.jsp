...
<body id="top1">
		...
		<section class="loginbox">
			<h2 class="jejuh2"><span>제주</span>여행</h2>
				<form name="myform" method="post" action="login.mem" onsubmit="javascript:logcheck(); return false;"> <!--텍스트가 아닌 파일을 넘길때는 post가 아니라 enctype="multipart/form-data"라고 해야함 -->
