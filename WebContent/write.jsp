...
<body id="top1">
        ...
        "multipart request" 쓰려면 C:\Program Files\Apache Software Foundation\Tomcat 9.0\lib\cos.jar 있어야 업로드 기능 쓸 수 있다-->
				...
				%>
				<select class="adminselect" name="type" id="types">
			
				<%if(type.equals("healing")==true) {%>
					<option value="healing" selected="selected"> 힐링여행 </option>
					<option value="nature"> 자연여행 </option>
					<option value="winter"> 겨울여행  </option>
				<%}else if(type.equals("nature")==true) {%>	
					<option value="healing" > 힐링여행 </option>
					<option value="nature"selected="selected"> 자연여행 </option>
					<option value="winter"> 겨울여행  </option>
				<%}else if(type.equals("winter")==true){ %>	
					<option value="healing"> 힐링여행 </option>
					<option value="nature"> 자연여행 </option>
					<option value="winter" selected="selected"> 겨울여행  </option>
				<%}else{ %>
